    ...
    return (
        <div className={'bg-theme-orange rounded-[20px] overflow-hidden'}>
            <div className={'p-[20px] border-b-4 border-b-theme-orange-dark flex justify-between items-center gap-[20px]'}>
                <h1 className={'text-white font-bold text-[18px] truncate tracking-wide'}>MOHAMAD MAHDI TASHA</h1>
            ...
            <div>
                <div className={'p-[20px]'}>
                    <MonitorComponent hasWhiteSide={true}>
                        <div className={'h-[200px] flex justify-center items-center'}>
                            <Image src={ImageOfLogoWithNoBG.src} alt={'Logo Of Mahdi Tasha'} width={100} height={100} />
                        </div>
                    </MonitorComponent>
                    <div className={'mt-[20px] p-[15px] rounded-[10px] bg-theme-orange-dark mb-[20px]'}>
                        <div className={'flex line-bg bg-cover rounded-[10px] relative h-[57px]'}>
                            <button className={'bg-sky-500 z-[2] absolute left-0 top-0 px-[30px] py-[15px] rounded-[5px] text-sky-700 font-bold text-[18px] tracking-wide shadow-[0_0.5em_0] shadow-sky-800 translate-y-[-10px] transition-all hover:shadow-transparent hover:translate-y-0 duration-400 active:translate-y-0 active:shadow-[0_inset_-0.5em_0]'}>
                                CONTACT ME
                            </button>
                            <span className={'block absolute left-[87%] top-[50%] translate-y-[-50%]'}><IconComponent name={'right-arrow-stroke'} size={50} /></span>
                        </div>
                    </div>
                    <p className={'text-white font-light line-clamp-5 text-[20px]'}>
                        I'm mahdi tasha <br/>
                ...
                <div className={'w-[80%] h-[70px] bg-darker-theme rounded-t-[20px] mx-auto'} />
            </div>
        </div>
    );
}